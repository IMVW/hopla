...
iris = User.new(email:"#{fn[0]}@gmail.com", password: pw, password_confirmation: pwc, first_name: fn[0], last_name: ln[0] , role: rl[0], phone_number:"+31-655-5288-83", skills: skills.sample(2), birthday:"27.07.1994")
